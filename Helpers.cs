...
namespace Advantage.API
{
  public class Helpers
  {
    ...
    {
      "The", "My", "Meta", "Best", "Family", "Enterprise", "Magic", "Simply", "Head",
      "Quick", "Rush", "Front", "Solo", "Smart", "Cool", "Hot", "Fast", "Sleek", "Top",
      "Free", "Great", "Classic", "Fresh", "Light", "Metro", "Hit", "Cyber", "Ultra"
    };

    private static readonly List<string> bizSuffix = new List<string>()
    {
      "House", "Central", "Point", "Home", "Place", "Garden", "Site", "Spot", "Park",
      "Dome", "Bay", "Web", "Net", "Cave", "Base", "Heaven", "Portal", "World", "Camp",
      "Network", "County", "Street", "City", "Alley", "Depot", "Valley"
    };
  }
}
